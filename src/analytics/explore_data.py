...
results_path = "data/processed/player_4313439_results.parquet"
...
# Extract match type (singles or doubles)
df_results["match_type"] = df_results["match_type"].apply(lambda x: "Doubles" if x == "DOUBLES" else "Singles")
